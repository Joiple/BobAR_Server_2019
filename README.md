...
- 음식점 고유 번호와 해당 음식점의 최근 리뷰 사진  
    ...
    (2)리뷰사진 요청  
    client code : 4  
    client request : client code%%image file name%%  
  
    ex)4%%000000100000100000001%%  
...
- 해당 음식점 정보와 가장 최근 리뷰  
    client code : 2  
    client request : client code%%restaurant id%%  
...
-리뷰 데이터 요청  
    client code : 5  
    client request : client code%%review id%%
